(function () {
  ...
  const storageKey = 'mufinances.workspace.controller.activeSections.v2';
  const numberStorageKey = 'mufinances.workspace.controller.activeNumbers.v2';
  const menuOpenKey = 'mufinances.workspace.controller.menuOpen';
  const changedThisSessionKey = 'mufinances.workspace.controller.changedThisSession';
  ...
  function ensureStyles() {
    if (document.querySelector('#workspacecontrollerStyles')) return;
    const style = document.createElement('style');
    style.id = 'workspacecontrollerStyles';
    style.textContent = `
      #${buttonId} {
  ...
  function ensureTray() {
    ...
    if (tray.dataset.controllerBuilt === 'true') return tray;
    ...
    tray.dataset.controllerBuilt = 'true';
    return tray;
  }
